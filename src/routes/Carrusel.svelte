<script>
  export let images = [
    { path: "/img/img01.jpg", description: "Ensou Sushi" },
    { path: "/img/img02.jpg", description: "Ensou Sushi" },
    { path: "/img/img03.jpg", description: "Ensou Sushi" },
    { path: "/img/img04.jpg", description: "Ensou Sushi" },
  ];
